...
class Access(nn.Module):
    ...
    def forward(self, input_seq, hidden=None):
        ...
        output, hidden = self.gru(embedded.unsqueeze(0), hidden.unsqueeze(0))
        output = self.softmax(self.out(output.squeeze(0)))
        return output, hidden.squeeze(0)  # Squeeze back to 2-D if needed
    
    def initHidden(self, hidden_size, device):
...
if __name__ == "__main__":
    ...
    print("With hidden_size = ", hidden_size)
